    ...
    <div className={styles.gradientbackground}>
      ...
      <div>
        ...
        >
          <div className={styles.flipcardfront}>
            <Image src="/cardwheelofshameback.svg" width={333} height={500} />
          </div>
          <div className={styles.flipcardback}>
            <Image src="/cardwheelofshamefront.svg" width={333} height={500} />
          </div>
        </div>
        <div
          style={{
      ...
      >
        <div className="d-flex justify-content-center">
          ...
          <div className="ml-5">
            <Image src="/cardwheelofshametext.svg" width={333} height={500} />
          </div>
