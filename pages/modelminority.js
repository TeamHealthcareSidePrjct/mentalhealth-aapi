    ...
    <div className={styles.gradientbackground}>
      ...
      <div>
        ...
        >
          <div className={styles.flipcardfront}>
            <Image src="/cardmodelminorityback.svg" width={333} height={500} />
          </div>
          <div className={styles.flipcardback}>
            <Image src="/cardmodelminorityfront.svg" width={333} height={502} />
          </div>
        </div>
        <div
          style={{
      ...
      >
        <div className="d-flex justify-content-center">
          <div className="mr-5">
            <Image src="/cardmodelminorityfront.svg" width={333} height={500} />
          </div>
          <div className="ml-5">
            <Image src="/cardmodelminoritytext.svg" width={333} height={502} />
          </div>
